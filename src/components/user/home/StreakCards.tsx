...
const cardStyles = [
  { border: "border-amber-200/60 dark:border-amber-800/40", from: "from-gray-50", via: "via-amber-50/80", to: "to-amber-50/50", darkFrom: "dark:from-amber-950/30", darkVia: "dark:via-amber-900/20", darkTo: "dark:to-amber-950/20", iconBg: "bg-amber-100 dark:bg-amber-900/50", iconColor: "text-amber-600 dark:text-amber-400", textColor: "text-amber-700 dark:text-amber-300", labelColor: "text-amber-600 dark:text-amber-400", barBg: "bg-amber-200 dark:bg-amber-800/50", barFill: "bg-amber-500" },
  { border: "border-emerald-200/60 dark:border-emerald-800/40", from: "from-gray-50", via: "via-emerald-50/80", to: "to-teal-50/50", darkFrom: "dark:from-emerald-950/30", darkVia: "dark:via-emerald-900/20", darkTo: "dark:to-teal-950/20", iconBg: "bg-emerald-100 dark:bg-emerald-900/50", iconColor: "text-emerald-600 dark:text-emerald-400", textColor: "text-emerald-700 dark:text-emerald-300", labelColor: "text-emerald-600 dark:text-emerald-400", barBg: "bg-emerald-200 dark:bg-emerald-800/50", barFill: "bg-emerald-500" },
  { border: "border-teal-200/60 dark:border-teal-800/40", from: "from-gray-50", via: "via-teal-50/80", to: "to-emerald-50/50", darkFrom: "dark:from-teal-950/30", darkVia: "dark:via-teal-900/20", darkTo: "dark:to-emerald-950/20", iconBg: "bg-teal-100 dark:bg-teal-900/50", iconColor: "text-teal-600 dark:text-teal-400", textColor: "text-teal-700 dark:text-teal-300", labelColor: "text-teal-600 dark:text-teal-400", barBg: "bg-teal-200 dark:bg-teal-800/50", barFill: "bg-teal-500" },
  { border: "border-gray-200/60 dark:border-gray-700/40", from: "from-gray-50", via: "via-gray-50/80", to: "to-gray-100/50", darkFrom: "dark:from-gray-900/40", darkVia: "dark:via-gray-900/30", darkTo: "dark:to-gray-950/20", iconBg: "bg-gray-100 dark:bg-gray-800/50", iconColor: "text-gray-600 dark:text-gray-400", textColor: "text-gray-700 dark:text-gray-300", labelColor: "text-gray-600 dark:text-gray-400", barBg: "bg-gray-200 dark:bg-gray-700/50", barFill: "bg-gray-500" },
]
