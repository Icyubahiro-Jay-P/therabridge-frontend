...
const cardStyles = [
  ...
  { border: "border-teal-200/60 dark:border-teal-800/40", from: "from-teal-50", via: "via-teal-50/80", to: "to-emerald-50/50", darkFrom: "dark:from-teal-950/30", darkVia: "dark:via-teal-900/20", darkTo: "dark:to-emerald-950/20", iconBg: "bg-teal-100 dark:bg-teal-900/50", iconColor: "text-teal-600 dark:text-teal-400", textColor: "text-teal-700 dark:text-teal-300", labelColor: "text-teal-600 dark:text-teal-400", barBg: "bg-teal-200 dark:bg-teal-800/50", barFill: "bg-teal-500" },
